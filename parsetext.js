    ...
    for(let i=0; i<1; i++){
        ...
        let urlphrase = 'День ' + thisdate.toLocaleString("ru", options) +  ' года – факты, гороскоп, люди ';
               alldata  = '<h1>' + urlphrase + '</h1><br />'
                        ...
                        + '<div class="pagepunkt"> Славянский знак зодиака: ' + ' НЕТ ДАННЫХ ' + ' ЗДЕСЬ БУДЕТ ТЕКСТ ИЗ ФАЙЛА ' + '</div><br />'
                        + '<div class="pagepunkt"> Славянский год: ' + ' НЕТ ДАННЫХ ' + ' ЗДЕСЬ БУДЕТ ТЕКСТ ИЗ ФАЙЛА ' + '</div><br />'
